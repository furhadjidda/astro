...
if diagnostic.checkttyACM0:
    ...
    os.system("xterm -e roslaunch astro_bringup astro_core.launch &")
    ...
    if diagnostic.checkttyUSB0:
        ...
        os.system("xterm -e roslaunch --wait astro_bringup astro_lidar.launch &")

    print("Launching SLAM")
    os.system("xterm -e roslaunch --wait astro_slam astro_gmapping.launch &")
