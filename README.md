...
<img src="docs/images/atro.jpeg" alt="Astro Robot" width="250">
...
| [ROS 2 Packages](docs/ros2-packages.md) | All ROS 2 nodes, launch instructions, and cross-compile guide |
| [Pico Firmware](docs/pico-firmware.md) | Pico node descriptions, build commands, and driver library docs |
| [Zephyr Firmware](docs/zephyr-firmware.md) | Zephyr app builds, supported boards, and debugging |
| [Hardware Setup](docs/hardware-setup.md) | udev rules, device symlinks, VNC access, and useful commands |
| [Bill of Materials](BOM.md) | Parts list with purchase links |
...
|---|---|
| ![burger](docs/images/astro_urdf_burger.png) | ![waffle](docs/images/astro_urdf_waffle.png) |
