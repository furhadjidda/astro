...
|----------|-------------|
| [Build, Flash, and Use](build-flash-use.md) | Canonical setup, build, flash, deployment, launch, and cleanup instructions |
| [Repository Tools](tools.md) | Purpose, usage, dependencies, and caveats for every repository utility |
...
| [Diagram Authoring Guide](DIAGRAMS.md) | How PlantUML diagrams are authored, encoded, and embedded |
...
See [Build, Flash, and Use](build-flash-use.md) for Zephyr firmware, flashing, deployment, and cleanup. See [ROS 2 Packages](ros2-packages.md) for all launch arguments and additional launch files.
