...
// Real Time debug GPIO with oscilloscope
#define RT_PIN0 46
#define RT_PIN1 48

DriveTrain::DriveTrain()
    : mTeleopSubscriber( "cmd_vel", &DriveTrain::CommandVelocityCallback, this )
{
}
...
void DriveTrain::UpdateOdometry()
{
    ...
    if( mFreqController.delay( millis() ) ) 
    {
        ...
        // update odometry
    if( mFreqOdometry.delay( millis() ) ) 
    {
        PublishOdom();
    }

    if( mFreqRosSpinOnce.delay( millis() ) ) 
    {
