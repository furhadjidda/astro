...
: ${AMENT_CURRENT_PREFIX:="/projects/github_repos/astro/ros2_ws/install/astro_odometry_tf_broadcaster"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/astro_odometry_tf_broadcaster/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/astro_odometry_tf_broadcaster/environment/path.sh"
